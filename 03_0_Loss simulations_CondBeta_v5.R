...
# param.pest.A <- list(a_cs=dat.beta.pest$a.A[dat.beta.pest$pest == "cs"], b_cs=dat.beta.pest$b.A[dat.beta.pest$pest == "cs"],
#                      a_fg=dat.beta.pest$a.A[dat.beta.pest$pest == "fg"], b_fg=dat.beta.pest$b.A[dat.beta.pest$pest == "fg"],
#                      m_mg_wld = 0, 
#                      a_mg_SBA=dat.beta.pest$a.A[dat.beta.pest$pest == "mg_SBA"], b_mg_SBA=dat.beta.pest$b.A[dat.beta.pest$pest == "mg_SBA"],
#                      a_mg_IGP=dat.beta.pest$a.A[dat.beta.pest$pest == "mg_IGP"], b_mg_IGP=dat.beta.pest$b.A[dat.beta.pest$pest == "mg_IGP"],
#                      a_pg=dat.beta.pest$a.A[dat.beta.pest$pest == "pg"], b_pg=dat.beta.pest$b.A[dat.beta.pest$pest == "pg"],
#                      a_ps=dat.beta.pest$a.A[dat.beta.pest$pest == "ps"], b_ps=dat.beta.pest$b.A[dat.beta.pest$pest == "ps"],
#                      a_pt=dat.beta.pest$a.A[dat.beta.pest$pest == "pt"], b_pt=dat.beta.pest$b.A[dat.beta.pest$pest == "pt"],
#                      a_st=dat.beta.pest$a.A[dat.beta.pest$pest == "st"], b_st=dat.beta.pest$b.A[dat.beta.pest$pest == "st"])

# param.pest.US <- list(a_cs=dat.beta.pest$a.WLD[dat.beta.pest$pest == "cs"], b_cs=dat.beta.pest$b.WLD[dat.beta.pest$pest == "cs"], 
#                      a_fg=dat.beta.pest$a.US[dat.beta.pest$pest == "fg"], b_fg=dat.beta.pest$b.US[dat.beta.pest$pest == "fg"],
#                      m_mg = 0,
...
#                      a_pg=dat.beta.pest$a.US[dat.beta.pest$pest == "pg"], b_pg=dat.beta.pest$b.US[dat.beta.pest$pest == "pg"],
#                      a_ps=dat.beta.pest$a.US[dat.beta.pest$pest == "ps"], b_ps=dat.beta.pest$b.US[dat.beta.pest$pest == "ps"],
#                      a_pt=dat.beta.pest$a.US[dat.beta.pest$pest == "pt"], b_pt=dat.beta.pest$b.US[dat.beta.pest$pest == "pt"],
#                      a_st=dat.beta.pest$a.US[dat.beta.pest$pest == "st"], b_st=dat.beta.pest$b.US[dat.beta.pest$pest == "st"])
...
# param.pest.WLD <- list(a_cs=dat.beta.pest$a.WLD[dat.beta.pest$pest == "cs"], b_cs=dat.beta.pest$b.WLD[dat.beta.pest$pest == "cs"], 
#                       a_fg=dat.beta.pest$a.WLD[dat.beta.pest$pest == "fg"], b_fg=dat.beta.pest$b.WLD[dat.beta.pest$pest == "fg"],
#                       m_mg = 0, 
#                       a_mg_SBA=dat.beta.pest$a.WLD[dat.beta.pest$pest == "mg_SBA"], b_mg_SBA=dat.beta.pest$b.WLD[dat.beta.pest$pest == "mg_SBA"],
#                       a_mg_IGP=dat.beta.pest$a.WLD[dat.beta.pest$pest == "mg_IGP"], b_mg_IGP=dat.beta.pest$b.WLD[dat.beta.pest$pest == "mg_IGP"],
#                       a_pg=dat.beta.pest$a.WLD[dat.beta.pest$pest == "pg"], b_pg=dat.beta.pest$b.WLD[dat.beta.pest$pest == "pg"],
#                       a_ps=dat.beta.pest$a.WLD[dat.beta.pest$pest == "ps"], b_ps=dat.beta.pest$b.WLD[dat.beta.pest$pest == "ps"],
#                       a_pt=dat.beta.pest$a.WLD[dat.beta.pest$pest == "pt"], b_pt=dat.beta.pest$b.WLD[dat.beta.pest$pest == "pt"],
#                       a_st=dat.beta.pest$a.WLD[dat.beta.pest$pest == "st"], b_st=dat.beta.pest$b.WLD[dat.beta.pest$pest == "st"])
...
# # All time average loss using US beta-distribution
# loss.sim.US <- fx.loss.sim(obs.N, "beta", param.pest.US)
# save(loss.sim.US, file="./Fin Data/03_0_loss.sim_v3_US.RData")
# 
# # All time average loss using Savary World beta-distribution
# loss.sim.WLD <- fx.loss.sim(obs.N, "beta", param.pest.WLD)
# save(loss.sim.WLD, file="./Fin Data/03_0_loss.sim_v3_WLD.RData")
